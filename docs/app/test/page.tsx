...
import * as Mention from "../../../packages/mention";
...
export function MentionDemo() {
  ...
  return (
    <div>
    <Mention.Root
      className="w-full max-w-[400px] **:data-tag:rounded **:data-tag:bg-blue-200 **:data-tag:py-px **:data-tag:text-blue-950 dark:**:data-tag:bg-blue-800 dark:**:data-tag:text-blue-50"
